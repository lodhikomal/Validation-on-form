    ...
    <div>
      <div className="form-container">
        ...
        >
          ...
          ></path>
          <path
            d="M379.991 16.8164H90.2441V180.033H379.991V16.8164Z"
            fill="#E6E6E6"
          ></path>
          <path
            d="M368.27 25.3164H103V166.396H368.27V25.3164Z"
            fill="white"
          ></path>
          <path
          ...
          ></path>
          <path
            d="M264.681 111.854H205V112.412H264.681V111.854Z"
            fill="#CCCCCC"
          ></path>
          <path
          ...
          ></path>
          <path
            d="M264.681 130.699H205V131.258H264.681V130.699Z"
            fill="#CCCCCC"
          ></path>
          <path
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-field">
            ...
            <div className="form-group">
              ...
              <input
                className={`text-input ${
                  touched.lname && errors.lname ? "error-border" : ""
                }`}
                type="text"
                id="lname"
                name="lname"
            ...
            <div className="form-group">
              ...
              <input
                className={`text-input ${
                  touched.number && errors.number ? "error-border" : ""
                }`}
                type="number"
                id="number"
                name="number"
            ...
            <div className="form-group">
              ...
              <input
                className={`text-input ${
                  touched.address && errors.address ? "error-border" : ""
                }`}
                type="text"
                id="address"
                name="address"
            ...
            <div className="form-group">
              <label className="form-label" for="str_address">
                Street Address Line2
              </label>
              <input
                className={`text-input ${
                  touched.str_address && errors.str_address
                    ? "error-border"
                    : ""
                }`}
                type="text"
                id="str_address"
                name="str_address"
                value={values.str_address}
                onChange={handleChange}
                onBlur={handleBlur}
              />
              {errors.str_address && touched.str_address ? (
                <p className="error-message">{errors.str_address}</p>
              ) : null}
            </div>
            <div className="form-group">
              ...
              <input
                className={`text-input ${
                  touched.state && errors.state ? "error-border" : ""
                }`}
                type="text"
                id="state"
                name="state"
            ...
            <div className="form-group">
              ...
              <input
                className={`text-input ${
                  touched.country && errors.country ? "error-border" : ""
                }`}
                type="text"
                id="country"
                name="country"
            ...
            <div className="form-group">
              ...
              <input
                className={`text-input ${
                  touched.post && errors.post ? "error-border" : ""
                }`}
                type="Number"
                id="post"
                name="post"
              ...
              {errors.post && touched.post ? (
                <p className="error-message">{errors.post}</p>
              ) : null}
            </div>
            <div className="form-group">
              ...
              <input
                className={`text-input ${
                  touched.area && errors.area ? "error-border" : ""
                }`}
                type="Number"
                id="area"
                name="area"
